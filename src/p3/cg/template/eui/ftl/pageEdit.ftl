		...
		<div class="row">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="dailogForm" action="$!{basePath}/${bussPackage}/back/${lowerName}/doEdit.html" method="POST">
						 ...
						 <input type="hidden" value="$!{${lowerName}.id}" name="id" id="id" />
									...
									<div class="form-group mno">
											<div class="col-sm-offset-1 col-sm-6">
												<button type="button" class="btn btn-default" id="formReturn" data-dismiss="modal" onclick="doUrl('$!{basePath}/${bussPackage}/back/${lowerName}/list.html')">返回</button>
