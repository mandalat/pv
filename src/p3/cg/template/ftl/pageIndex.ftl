...
<body style='overflow:scroll;overflow-x:hidden'>
	<div class="container bs-docs-container" style="width:100%;">
		<div class="row">
			<form role="form" class="form-inline" action="$!{basePath}/${bussPackage}/back/${lowerName}/list.html" method="post"  id="formSubmit">
				<div  class="col-md-10" style="width:100%">
								<div class="panel panel-default">
								  ...
								  <div class="panel-body">
								  		...
								  		<div id="legend">
								          <legend  class="le"><button type="button" class="btn btn-primary" onclick="doUrl('$!{basePath}/${bussPackage}/back/${lowerName}/toAdd.html')" >新增</button></legend> 
								        </div>
									        ...
									        <tobody>
								                ...
								                #foreach($!{info} in $!{pageInfos})
									            	<tr>			
										                ...
										                <td class="last">
							                			<a href="javascript:doUrl('$!{basePath}/${bussPackage}/back/${lowerName}/toEdit.html?id=$!{info.id}')" >编辑</a>
							                			<a href="javascript:delData('$!{basePath}/${bussPackage}/back/${lowerName}/doDelete.html?id=$!{info.id}')">删除</a>
							                			<a href="javascript:doUrl('$!{basePath}/${bussPackage}/back/${lowerName}/toDetail.html?id=$!{info.id}')">详情</a>
						                				</td>
									           		</tr>
									             #end
									    	 #end
