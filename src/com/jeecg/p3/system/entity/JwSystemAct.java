  ...
  implements Entity<String>
{
  ...
  public String toString() {
    return "JwSystemAct [id=" + this.id + ", actCode=" + this.actCode + ", actName=" + this.actName + ", actDiscribe=" + this.actDiscribe + ", jwid=" + this.jwid + ", jwidName=" + this.jwidName + ", type=" + this.type + ", creatName=" + this.creatName + ", creatTime=" + this.creatTime + ", updateName=" + this.updateName + ", updateTime=" + this.updateTime + "]";
  }
}