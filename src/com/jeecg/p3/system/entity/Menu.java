  ...
  implements Serializable
{
  ...
  public String toString() {
    return "Menu [userId=" + this.userId + ", authId=" + this.authId + ", authName=" + this.authName + ", authContr=" + this.authContr + ", parentAuthId=" + this.parentAuthId + ", authType=" + this.authType + ", childMenu=" + this.childMenu + ", selected=" + this.selected + ", authDesc=" + this.authDesc + ", roleId=" + this.roleId + ", roleName=" + this.roleName + "]";
  }
}